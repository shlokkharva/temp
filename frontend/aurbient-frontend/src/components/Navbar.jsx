    ...
    <>
      ...
      >
        ...
        <Link to="/" className="flex items-center gap-2.5 no-underline">
          <div className="w-9 h-9 rounded-full border border-[#3B82F6]/40 flex items-center justify-center bg-[#3B82F6]/10">
          ...
          <div className="leading-tight">
            <div style={{ fontFamily:"'Barlow',sans-serif", fontWeight:600, fontSize:"0.95rem", color:"#fff", letterSpacing:"0.02em" }}>Aurbient</div>
            <div style={{ fontFamily:"'Barlow',sans-serif", fontWeight:400, fontSize:"0.6rem", color:"rgba(255,255,255,0.5)", letterSpacing:"0.2em" }}>TECHNOLOGIES</div>
          </div>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-6">
          {links.map(l => (
            <NavLink
              ...
              onMouseEnter={e => { if (e.target.style.color !== "#3B82F6") e.target.style.color = "#fff"; }}
              onMouseLeave={e => { if (e.target.style.color !== "#3B82F6") e.target.style.color = "rgba(255,255,255,0.7)"; }}
            >
              {l}
            </NavLink>
          ))}
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            style={{
              fontFamily:"'Barlow',sans-serif", background:"rgba(255,255,255,0.1)",
              border:"1px solid rgba(255,255,255,0.2)", color:"#fff", textDecoration:"none",
              transition:"all 0.2s",
            }}
          >
            Let's Build <span style={{ color:"#3B82F6" }}>▼</span>
          </Link>
          <button
        ...
        >
          {[...links, "Contact"].map(l => (
            <NavLink
              ...
              style={{ fontFamily:"'Barlow',sans-serif", fontSize:"1.5rem", fontWeight:300, color:"rgba(255,255,255,0.8)", textDecoration:"none" }}
            >
              {l}
            </NavLink>
          ))}
