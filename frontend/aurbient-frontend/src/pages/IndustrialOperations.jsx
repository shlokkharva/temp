...
export default function IndustrialOperations() {
  const image = "/@fs/C:/Users/shlok/.gemini/antigravity/brain/237ae5d4-2088-4c38-86d9-21b74545b555/aurbient_ind_operations_1779956611748.png";
    ...
    <main style={{ background: "#F4F9FB", minHeight: "100vh" }}>
      ...
      <section className="hero case-study-hero" style={{ 
        ...
        <div className="container" style={{ position: "relative", zIndex: 2, color: "white" }}>
          ...
          <span style={{ fontSize: "1rem", color: "var(--color-accent)", textTransform: "uppercase", fontWeight: "700", letterSpacing: "3px", display: "block", marginBottom: "20px" }}>Industries Ecosystem 02</span>
          <h1 style={{ fontSize: "clamp(2.5rem, 5vw, 4rem)", marginBottom: "30px", maxWidth: "900px", lineHeight: "1.15", textShadow: "0 4px 20px rgba(0,0,0,0.4)", fontWeight: "600" }}>Industrial Operations & Plant Integration</h1>
          <div style={{ display: "inline-block", padding: "10px 28px", background: "rgba(19, 170, 179, 0.15)", backdropFilter: "blur(10px)", color: "white", borderRadius: "50px", fontSize: "1rem", fontWeight: "600", border: "1px solid rgba(19, 170, 179, 0.4)" }}>
            Heavy Process Sync & Facility Telemetry Console
          </div>
        </div>
      </section>
      ...
      <div className="container" style={{ position: "relative", zIndex: 10, marginTop: "-80px", paddingBottom: "80px" }}>
        ...
        <div className="eco-card" style={{ background: "white", padding: "50px", borderRadius: "24px", boxShadow: "0 20px 60px rgba(0,0,0,0.05)", marginBottom: "50px" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1.3fr 1fr", gap: "60px", alignItems: "center" }}>
            <div>
              <h3 style={{ fontSize: "2rem", marginBottom: "24px", color: "var(--color-primary)", fontWeight: "600" }}>Synchronized Plant Architecture</h3>
              <p style={{ color: "#395568", marginBottom: "20px", lineHeight: "1.9", fontSize: "1.15rem" }}>
                Heavy industrial operations operate in complex physical-digital zones. Connecting plant sensors, machinery grids, and resource pipelines securely is standard for modern operational clarity.
              </p>
              <p style={{ color: "#395568", marginBottom: "0", lineHeight: "1.9", fontSize: "1.15rem" }}>
                Aurbient Technologies implements secure industrial telemetry layers that synchronize multi-site assets, aggregate facility logs, and protect legacy process controllers.
              </p>
            </div>
            <div style={{ padding: "40px", background: "linear-gradient(135deg, var(--color-primary) 0%, #111d25 100%)", color: "white", borderRadius: "20px", boxShadow: "0 20px 40px rgba(26, 42, 53, 0.25)", position: "relative", overflow: "hidden" }}>
              ...
              <p style={{ fontStyle: "italic", lineHeight: "1.8", fontSize: "1.2rem", margin: 0, position: "relative", zIndex: 2 }}>
                "Operational safety and high-fidelity visibility must scale together. When facility logs sync, administrative blind spots disappear."
              </p>
            </div>
          </div>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "40px", marginBottom: "60px" }}>
          ...
          <div className="eco-card" style={{ background: "white", padding: "50px", borderRadius: "24px", boxShadow: "0 10px 30px rgba(0,0,0,0.02)", borderTop: "4px solid var(--color-accent)" }}>
            ...
            <ul style={{ listStyle: "none", padding: 0, display: "flex", flexDirection: "column", gap: "16px" }}>
              {[
                "Multi-facility telemetry databases",
                "Resilient industrial API gateways",
                "Anomaly alert sequence pipelines",
                "Administrative plant reports",
                "Centralized facility sync dashboards",
                "Operational risk map auditing",
                "Hardware-to-software bridges"
              ].map((item, i) => (
          ...
          <div className="eco-card" style={{ background: "white", padding: "50px", borderRadius: "24px", boxShadow: "0 10px 30px rgba(0,0,0,0.02)", borderTop: "4px solid #8E44AD" }}>
            ...
            <ul style={{ listStyle: "none", padding: 0, display: "flex", flexDirection: "column", gap: "16px" }}>
              {[
                "100% database isolation protection",
                "Zero plant data aggregation delays",
                "18% increase in process output",
        ...
        <div style={{ marginBottom: "80px" }}>
          <div style={{ textAlign: "center", maxWidth: "700px", margin: "0 auto 50px" }}>
            ...
            <p style={{ color: "#58798C", fontSize: "1.1rem" }}>Targeted engineering systems designed to coordinate modern heavy industrial assemblies.</p>
          </div>

          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))", gap: "30px" }}>
            {[
              {
                title: "Process Telemetry Sync",
                desc: "Ingest massive SCADA, PLC, and sensor metrics in parallel with sub-second latency for immediate management visibility.",
                icon: "fa-satellite-dish",
                color: "#13AAB3"
              },
              {
                title: "Predictive Mapping",
                desc: "Deploy AI safety agents that process operational sequences to spot pressure or system bottlenecks before failures cascade.",
                icon: "fa-shield-alt",
                color: "#3498db"
              },
              {
                title: "Legacy Grid Bridges",
                desc: "Build resilient pipelines linking legacy industrial hardware directly to modern cloud monitoring systems without safety compromises.",
                icon: "fa-project-diagram",
                color: "#e67e22"
              },
              {
                title: "Resource Coordination",
                desc: "Dynamically align energy pipelines, thermal distribution, and mechanical assets into one dashboard layout.",
                icon: "fa-cubes",
                color: "#2ecc71"
              }
            ].map((focus, i) => (
        ...
        <section style={{ padding: "80px 0", background: "var(--color-primary)", color: "white", textAlign: "center", borderRadius: "24px", overflow: "hidden", boxShadow: "0 20px 50px rgba(14,25,33,0.15)" }}>
          <div style={{ maxWidth: "800px", margin: "0 auto", padding: "0 40px" }}>
            <h2 style={{ fontSize: "2.5rem", marginBottom: "24px", color: "white" }}>Connect Your Industrial Assets</h2>
            <p style={{ fontSize: "1.2rem", lineHeight: "1.8", opacity: 0.9, marginBottom: "40px" }}>
              Work with our systems architects to design an integrated digital bridge that brings real-time clarity and absolute security to your plant environment.
            </p>
